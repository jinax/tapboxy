<?php
if (PHP_SESSION_ACTIVE && isset($_SESSION['nick'])) {
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarColor01">
    ...
    <form class="form-inline my-2 my-lg-0" action="busqueda.php" method="post">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item">
          <input class="form-control mr-sm-2" type="text" name="campobuscar" placeholder="Buscar cajas públicas">
          <button class="btn btn-secondary my-2 my-sm-0" type="submit" name="botonbuscar">Buscar</button>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="alta.php">Alta</a>
        </li>
        <li class="nav-item">
